...
class DocumentVaultPage extends StatelessWidget {
  ...
  void _showCategoryDocuments(
    ...
    showModalBottomSheet(
      ...
      backgroundColor: Colors.transparent,
      builder: (ctx) =>
          _CategoryDocsSheet(category: category, docs: docs, userId: userId),
    );
  }
  ...
  Future<void> _uploadNewDocument() async {
    ...
    if (result != null && result.files.first.bytes != null) {
      ...
      try {
        ...
        final fileUrl = await dbService.uploadFileToBucket(
          'documents',
          '${widget.userId}/${DateTime.now().millisecondsSinceEpoch}_$fileName',
          fileBytes,
        );
        ...
        children: [
          ...
          Expanded(
            child: widget.docs.isEmpty
                ? Center(
                    child: Text(
                      'No ${widget.category} uploaded yet.',
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (ctx, index) {
                      ...
                      return ListTile(
                        ...
                        title: Text(
                          d.fileUrl.split('/').last.split('_').last,
                          style: const TextStyle(fontSize: 14),
                          overflow: TextOverflow.ellipsis,
                        ),
                        subtitle: Text(
                          'Uploaded on ${d.uploadedAt.toLocal().toString().split(' ')[0]}',
          ...
          ElevatedButton.icon(
            ...
            label: Text(
              _isUploading ? 'Uploading...' : 'Upload New ${widget.category}',
            ),
