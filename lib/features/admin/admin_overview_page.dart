...
class AdminOverviewPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final todaysCasesCount = cases
        .where((c) => c.createdAt.startsWith(todaysDate))
        .length;

    // Metric 2: Today's Visits (Biometrics Scheduled)
    final todaysVisitsCount = cases
        .where((c) => c.status == AgreementStatus.biometricScheduled)
        .length;

    // Metric 3: Pending Cases
    final pendingCasesCount = cases
